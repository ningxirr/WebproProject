    ...
    <form>
      <div class="well" style="text-align:left">
        ...
        <div class="form-group" >
          ...
          <input type="text" class="form-control" placeholder="0899999999" v-model="Contact.mobile">
        </div><br>
        <div class="form-group" >
          <label class="pull-left">Email </label>
          <input type="text" class="form-control" placeholder="example@thaicss.com" v-model="Contact.email">
        </div><br>
        <div class="form-group" >
      ...
      <div style="text-align : center;">
        <sui-button-group>
          ...
          <sui-button basic color="blue" @click="addToAPI"><sui-icon name="save" />Save</sui-button>
          <!-- </router-link>  -->
          <router-link to="/contacts">
